...
<schema xmlns="http://purl.oclc.org/dsdl/schematron" queryBinding="xslt2">
    ...
    <let name="places" value="doc('../XML/common-affiliations.xml')//tei:place/@xml:id|doc('../XML/common-affiliations.xml')//tei:person/@xml:id"/>
    <pattern>
        ...
        <rule context="tei:affiliation">
            ...
            <assert test="if (@key) then @key ='mecenado' or 'familia' or 'politica' or 'literaria' or 'propriedade' else true()">A relaçom nom tem um valor conhecido</assert>
        </rule>
